...
```{r allele-frequency, fig.height = 6, fig.width = 10}
...
```{r results-plot, fig.height = 6, fig.width = 10}
AF <- as.matrix(input_data$A / input_data$D)
Config_binary <- assignments$Config_prob
Config_binary[Config_binary > 0.5] = 1
